...
public class Users {
     ...
     * 用户名
     */
    @ApiModelProperty(value = "用户名",name = "username",example = "user123", required = true)
    private String username;

    /**
     * 密码
     */
    @ApiModelProperty(value = "用户密码",name = "password",example = "abc123456",required = true)
